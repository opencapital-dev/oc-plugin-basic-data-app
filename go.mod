module github.com/portfoliomanagement/yfinance-ingestor
...
require (
	...
	github.com/portfolio-management/pluginclient v0.0.0
...
replace github.com/portfolio-management/pluginclient => ../../lib/pluginclient
